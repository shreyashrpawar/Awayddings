                                ...
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                        <tr>
                                            <td class="content-spacing" style="font-size:0pt; line-height:0pt; text-align:left" width="20"></td>
                                            <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:left; width:100%; min-width:100%"><tr><td height="35" class="spacer" style="font-size:0pt; line-height:0pt; text-align:left; width:100%; min-width:100%">&nbsp;</td></tr></table>
                                                @if($next_installment_date)
                                                    <div class="h3-1-center" style="color:#000; font-family:Arial, serif; min-width:auto !important; font-size:16px; line-height:26px; text-align:left">Your <b>{{ $installment_no ?? '' }}</b> No. instalment of Rs. <b>{{ number_format($installment_amount ?? '', 2, '.', ',') }}</b> is successfully paid. Your next amount Rs. <b>{{ number_format($installment_amount ?? '', 2, '.', ',') }}</b> which due date is <b>{{ $next_installment_date ?? '' }}</b>. <br/><br/>
                                                    Payment remark: <b>{{ $remarks ?? '' }}</b></div>
                                                @else
                                                    <div class="h3-1-center" style="color:#000; font-family:Arial, serif; min-width:auto !important; font-size:16px; line-height:26px; text-align:left">Your final instalment of Rs. <b>{{ number_format($installment_amount ?? '', 2, '.', ',') }}</b> is successfully paid. Thank you for your payment.
                                                    <br/><br/>
                                                    Payment remark: <b>{{ $remarks ?? '' }}</b></div>
                                                @endif
