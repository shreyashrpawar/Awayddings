    ...
    <div class="card">
        <div class="card-body">
            <div class="row form-group">
                <div class="col-md-6">
                    <h4 class="card-title text-uppercase">Light and Sounds</h4>
                </div>
                <div class="col-md-6 text-right">
                    <a href="{{ route('lightandsounds.create') }}" class="btn btn-sm btn-primary">Add</a>
                </div>
            </div>
            <div class="table-responsive">
                <table class="table" id="example1">
                    ...
                    <tbody>
                    @if($lightandSounds->count() > 0)
                        @foreach($lightandSounds as $key => $val)
                            <tr>
                                <th>{{ 1+ $key }}</th>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('lightandsounds.edit',$val->id) }}" class="btn btn-sm btn-outline-primary">Edit</a>
                                    </div>
