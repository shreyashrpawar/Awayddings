...
class CreateEmPrebookingAddsonDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('em_prebooking_addson_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('em_prebooking_addson_details');
    }
}
